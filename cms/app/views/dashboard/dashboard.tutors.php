						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  <?php foreach($users as $item){ ?>
								<tr>
									...
									<td class="center"><?php echo $item->login_status; ?></td>
									<td class="center">
										<div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<?php if($item->login_status == 'inactive'){ ?>
								<li><a href="<?php echo DIR.'dashboard/tutors?ac=activate&amp;id='.$item->id; ?>" onclick="return confirm('Are you sure?');">
								<i class="halflings-icon  tag"></i> Activate User</a></li>
								<?php } else if($item->login_status == 'active') { ?>
								<li><a href="<?php echo DIR.'dashboard/tutors?ac=deactivate&amp;id='.$item->id; ?>" onclick="return confirm('Are you sure?');">
								<i class="halflings-icon  tag"></i> Deactivate User</a></li>
								<?php } ?>
								<li><a 
								href="<?php echo DIR.'dashboard/tutors?ac=delete&amp;id='.$item->id; ?>"
