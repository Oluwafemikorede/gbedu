						...
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						  <fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<?php //Assets::image($item->album_image,'','width: 120px'); ?>
								</div>
							  </div>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>Album/Playlist</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <?php foreach($albums as $item){ ?>
								<tr>
									...
									<td class="center"><?php echo Song::itemCount($item->album_id); ?></td>
							...
							if($item->category_title == 'playlist'){ 
								$songUrl = DIR.'song/playlist/'.$item->album_id;
							} else {
