            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  ...
                  <?php $i=1; foreach($playlists as $item){ ?>
                        ...
                        <div class="pos-rlt">
                          ...
                          <div class="item-overlay opacity r r-2x bg-black">
                            ...
                            <div class="center text-center m-t-n">
                              <a href="<?php echo DIR.'playlist/listen/'.$item->album_slug; ?>"><i class="icon-control-play i-2x"></i></a>
                            </div>
                          ...
                          <a href="#">
                          <?php Assets::image($item->album_image,'r r-2x img-full',''); ?>
                          <?php //Assets::showThumb($item->album_image,'r r-2x img-full','width: 112px; height: 167px'); ?>
                          </a>
                        </div>
                        <div class="padder-v">
                          <a href="#" class="text-ellipsis"><?php echo $item->album_name; ?></a>
                    ...
                    <!-- <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#">
                          <?php echo Assets::image('images/p2.jpg','r r-2x img-full',''); ?>
                          </a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#">
                          <?php echo Assets::image('images/p3.jpg','r r-2x img-full',''); ?>
                          </a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#">
                          <?php echo Assets::image('images/p4.jpg','r r-2x img-full',''); ?>
                          </a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p5.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p6.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p7.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          <a href="#" class="text-ellipsis">Vivamus vel tincidunt libero</a>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p8.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p9.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p10.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p11.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<?php echo Url::templatePath(); ?>images/p12.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a2.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a3.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a8.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a9.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a1.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a6.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a7.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<?php echo Url::templatePath(); ?>images/a5.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                      ...
                      <div class="list-group bg-white list-group-lg no-bg auto">                          
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<?php echo Url::templatePath(); ?>images/a4.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<?php echo Url::templatePath(); ?>images/a5.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<?php echo Url::templatePath(); ?>images/a6.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<?php echo Url::templatePath(); ?>images/a7.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<?php echo Url::templatePath(); ?>images/a8.png" alt="...">
                          </span>
                          <span class="clear">
                  ...
                  <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a1.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a2.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a3.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a5.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a9.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<?php echo Url::templatePath(); ?>images/a1.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Amanda Conlan</a></div>
